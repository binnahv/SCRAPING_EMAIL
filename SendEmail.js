...
async function sendEmail(bookDetails) {
  ...
  let emailContent = `
    ...
    <p style="text-align: center; font-size: 1.1em;">Confira alguns livros disponíveis, com imagens, preços e status de estoque:</p>
    <table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif;">
      <thead>
        <tr style="background-color: #f4f4f4;">
          <th style="padding: 10px; border: 1px solid #ddd; text-align: left;">Imagem</th>
    ...
    emailContent += `
      <tr>
        <td style="padding: 10px; border: 1px solid #ddd;">
          <img src="${book.imageUrl}" alt="${book.titulo}" style="width: 60px; height: auto;"/>
        </td>
